// Perseverance rover page functionality
class PerseveranceController {
    ...
    async fetchImages(clearResults = true) {
        ...
        try {
            ...
            const response = await fetch(`/api/rover/perseverance/photos?${params}`);
    ...
    async fetchLatestImages(clearResults = true) {
        ...
        try {
            ...
            const response = await fetch(`/api/rover/perseverance/latest?${params}`);
